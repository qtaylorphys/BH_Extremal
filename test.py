...
def compute_BH_evolution(
    ...
    while M >= M_final:
        ...
        ang[i] = J
        rho_plus = 1 / 2 + c * (-a_star + a_star * np.abs(a_star) / 2)
...
if __name__ == "__main__":
    ...
    for _ in range(1):
        ...
        t1 = process_time()
        M, J, a, n, ang = compute_BH_evolution(init_M, init_J, M_final, changes_array, rands_array, ang)
        t2 = process_time()

        #with open(f"/home/qxt42/Documents/PBH_Extremal/test_M_{int(init_M)}_eq.txt", "a") as f:
